...
.controller("stockinCtrl", function ($scope, remoteCallSvc) {
    ...
    remoteCallSvc.post("http://localhost:3502/odata/Products/AcProducts", { "Authorization": "Bearer " + $scope.auth.accesstoken }, null)
    ...
    remoteCallSvc.get("http://localhost:3502/odata/StockIns?$expand=Product", { "Authorization": "Bearer " + $scope.auth.accesstoken }, null)
         .then(function (result) {
    ...
    $scope.saveProduct = function () {
        ...
        remoteCallSvc.post("http://localhost:3502/odata/StockIns?$expand=Product", { "Authorization": "Bearer " + $scope.auth.accesstoken }, $scope.model.current)
         .then(function (result) {
    ...
    $scope.delProduct = function () {
        remoteCallSvc.remove("http://localhost:3502/odata/StockIns(" + $scope.productToDel.StockInId + ")", { "Authorization": "Bearer " + $scope.auth.accesstoken }, null)
        .then(function (result) {
            //console.log(result);
    ...
    $scope.editProduct = function () {
        remoteCallSvc.put("http://localhost:3502/odata/StockIns(" + $scope.model.current.StockInId + ")", { "Authorization": "Bearer " + $scope.auth.accesstoken },
            $scope.model.current)
        .then(function (result) {
