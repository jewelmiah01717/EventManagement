...
.controller("orderCtrl", function ($scope, remoteCallSvc) {
    ...
    $scope.pandingOrder = function ()
    {
        ...
        remoteCallSvc.get("http://localhost:3502/odata/Orders?$filter=ShippedDate eq null", { "Authorization": "Bearer " + $scope.auth.accesstoken }, null)
    ...
    $scope.shippedOrder = function () {
        $scope.model.orders = null;
        remoteCallSvc.get("http://localhost:3502/odata/Orders?$filter=ShippedDate ne null", { "Authorization": "Bearer " + $scope.auth.accesstoken }, null)
        .then(function (result) {
    ...
    $scope.updateOrder = function () {
        remoteCallSvc.put("http://localhost:3502/odata/Orders(" + $scope.model.current.OrderId + ")",
    ...
    $scope.deleteOrder = function () {
        remoteCallSvc.remove("http://localhost:3502/odata/Orders(" + $scope.current.OrderId + ")", { "Authorization": "Bearer " + $scope.auth.accesstoken }, null)
        .then(function (result) {
            //console.log(result);
